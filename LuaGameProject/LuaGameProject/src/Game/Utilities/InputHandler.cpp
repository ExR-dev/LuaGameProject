...
std::string Input::GetKeyName(GameKey key)
{
	...
	case Input::GAME_KEY_APOSTROPHE					:		return "KEY_"; 
	case Input::GAME_KEY_COMMA						:		return "KEY_"; 
	case Input::GAME_KEY_MINUS						:		return "KEY_"; 
	case Input::GAME_KEY_PERIOD						:		return "KEY_"; 
	case Input::GAME_KEY_SLASH						:		return "KEY_"; 
	case Input::GAME_KEY_SEMICOLON					:		return "KEY_"; 
	case Input::GAME_KEY_EQUAL						:		return "KEY_"; 
	case Input::GAME_KEY_LEFT_BRACKET				:		return "KEY_"; 
	case Input::GAME_KEY_RIGHT_BRACKET				:		return "KEY_"; 
	...
	case Input::GAME_KEY_END						:		return "KEY_"; 
	case Input::GAME_KEY_CAPS_LOCK					:		return "KEY_"; 
	case Input::GAME_KEY_SCROLL_LOCK				:		return "KEY_"; 
	case Input::GAME_KEY_NUM_LOCK					:		return "KEY_"; 
	case Input::GAME_KEY_PRINT_SCREEN				:		return "KEY_"; 
	case Input::GAME_KEY_PAUSE						:		return "KEY_"; 
	case Input::GAME_KEY_F1							:		return "KEY_"; 
	case Input::GAME_KEY_F2							:		return "KEY_"; 
	case Input::GAME_KEY_F3							:		return "KEY_"; 
	case Input::GAME_KEY_F4							:		return "KEY_"; 
	case Input::GAME_KEY_F5							:		return "KEY_"; 
	case Input::GAME_KEY_F6							:		return "KEY_"; 
	case Input::GAME_KEY_F7							:		return "KEY_"; 
	case Input::GAME_KEY_F8							:		return "KEY_"; 
	case Input::GAME_KEY_F9							:		return "KEY_"; 
	case Input::GAME_KEY_F10						:		return "KEY_"; 
	case Input::GAME_KEY_F11						:		return "KEY_"; 
	case Input::GAME_KEY_F12						:		return "KEY_"; 
	case Input::GAME_KEY_LEFT_SHIFT					:		return "KEY_"; 
	case Input::GAME_KEY_LEFT_CONTROL				:		return "KEY_"; 
	case Input::GAME_KEY_LEFT_ALT					:		return "KEY_"; 
	case Input::GAME_KEY_LEFT_SUPER					:		return "KEY_"; 
	case Input::GAME_KEY_RIGHT_SHIFT				:		return "KEY_"; 
	case Input::GAME_KEY_RIGHT_CONTROL				:		return "KEY_"; 
	case Input::GAME_KEY_RIGHT_ALT					:		return "KEY_"; 
	case Input::GAME_KEY_RIGHT_SUPER				:		return "KEY_"; 
	case Input::GAME_KEY_KB_MENU					:		return "KEY_"; 
	case Input::GAME_KEY_NP_0						:		return "KEY_"; 
	case Input::GAME_KEY_NP_1						:		return "KEY_"; 
	case Input::GAME_KEY_NP_2						:		return "KEY_"; 
	case Input::GAME_KEY_NP_3						:		return "KEY_"; 
	case Input::GAME_KEY_NP_4						:		return "KEY_"; 
	case Input::GAME_KEY_NP_5						:		return "KEY_"; 
	case Input::GAME_KEY_NP_6						:		return "KEY_"; 
	case Input::GAME_KEY_NP_7						:		return "KEY_"; 
	case Input::GAME_KEY_NP_8						:		return "KEY_"; 
	case Input::GAME_KEY_NP_9						:		return "KEY_"; 
	case Input::GAME_KEY_NP_DECIMAL					:		return "KEY_"; 
	case Input::GAME_KEY_NP_DIVIDE					:		return "KEY_"; 
	case Input::GAME_KEY_NP_MULTIPLY				:		return "KEY_"; 
	case Input::GAME_KEY_NP_SUBTRACT				:		return "KEY_"; 
