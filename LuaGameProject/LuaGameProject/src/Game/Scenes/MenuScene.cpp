...
int MenuScene::MenuScene::Update()
{
    ZoneScopedC(RandomUniqueColor());
    ...
    if (Input::CheckKeyPressed(Input::GAME_KEY_C))
    {
        ...
        {
        case 0: default:
            m_cameraUpdater = std::bind(&MenuScene::UpdatePlayerCamera, this);
            break;

        case 1:
            m_cameraUpdater = std::bind(&MenuScene::UpdateFreeCamera, this);
            break;
        }
    }
...
int MenuScene::MenuScene::Render()
{
    ...
    // UI
    {
        ZoneNamedNC(MenuSceneRenderScene, "Render UI", RandomUniqueColor(), true);
...
void MenuScene::MenuScene::UpdatePlayerCamera()
{
    ZoneScopedC(RandomUniqueColor());
...
void MenuScene::MenuScene::UpdateFreeCamera()
{
    ZoneScopedC(RandomUniqueColor());
