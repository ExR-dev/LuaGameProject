...
private:
    ...
    UINT
        ...
        _realWindowWidth = 0, _realWindowHeight = 0;
...
public:
    ...
    [[nodiscard]] KeyCode GetPressedKey() const;
	void GetPressedKeys(std::vector<KeyCode> &keys) const;
    [[nodiscard]] MouseState GetMouse() const;
    [[nodiscard]] WindowSize GetWindowSize() const;
    [[nodiscard]] WindowSize GetRealWindowSize() const;
    [[nodiscard]] WindowSize GetActiveWindowSize() const;
