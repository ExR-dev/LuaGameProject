...
void ProjectOntoAxis(const Collisions::OBB &obb, const FXMVECTOR &normalizedAxis, float &maxProj, float &minProj)
{
...
DirectX::XMFLOAT3 Collisions::ClosestFacePoint(const OBB &obb, const DirectX::XMFLOAT3 &point, DirectX::XMFLOAT3 &outNormal, float &outDepth)
{
...
bool Collisions::PointInside(const OBB &obb, const DirectX::XMFLOAT3 &point)
{
...
bool Collisions::CircleTerrainWallIntersection(const Circle &c, const Terrain &t, float &depth, DirectX::XMFLOAT2 &normal)
{
...
bool Collisions::RaySphereIntersection(const Ray &ray, const Sphere &s, float &l, DirectX::XMFLOAT3 &p, DirectX::XMFLOAT3 &normal)
{
...
bool Collisions::RayCapsuleIntersection(const Ray &ray, const Capsule &c, float &l, DirectX::XMFLOAT3 &p, DirectX::XMFLOAT3 &normal)
{
	// Capsule
...
bool Collisions::RayAABBIntersection(const Ray &ray, const AABB &aabb, float &l, DirectX::XMFLOAT3 &p, DirectX::XMFLOAT3 &normal)
{
	return RayOBBIntersection(ray, OBB(aabb), l, p, normal);
}

bool Collisions::RayTerrainIntersection(const Ray &ray, const Terrain &t, float &l, DirectX::XMFLOAT3 &p, DirectX::XMFLOAT3 &normal)
{
...
bool Collisions::SphereRayIntersection(const Sphere &s, const Ray &ray, float &l, DirectX::XMFLOAT3 &p, DirectX::XMFLOAT3 &normal)
{
...
bool Collisions::SphereCapsuleIntersection(const Sphere &s, const Capsule &c, DirectX::XMFLOAT3 &normal, float &depth)
{
...
bool Collisions::SphereAABBIntersection(const Sphere &s, const AABB &aabb, DirectX::XMFLOAT3 &normal, float &depth)
{
...
bool Collisions::SphereTerrainIntersection(const Sphere &s, const Terrain &t, DirectX::XMFLOAT3 &normal, float &depth)
{
...
bool Collisions::CapsuleRayIntersection(const Capsule &c, const Ray &ray, float &l, DirectX::XMFLOAT3 &p, DirectX::XMFLOAT3 &normal)
{
...
bool Collisions::CapsuleCapsuleIntersection(const Capsule &c1, const Capsule &c2, DirectX::XMFLOAT3 &normal, float &depth)
{
...
bool Collisions::CapsuleAABBIntersection(const Capsule &c, const AABB &aabb, DirectX::XMFLOAT3 &normal, float &depth)
{
	return CapsuleOBBIntersection(c, OBB(aabb), normal, depth);
}

bool Collisions::CapsuleOBBIntersection(const Capsule &c, const OBB &obb, DirectX::XMFLOAT3 &normal, float &depth)
{
	// Capsule information
...
bool Collisions::CapsuleTerrainIntersection(const Capsule &c, const Terrain &t, DirectX::XMFLOAT3 &normal, float &depth)
{
...
bool Collisions::OBBRayIntersection(const OBB &obb, const Ray &ray, float &l, DirectX::XMFLOAT3 &p, DirectX::XMFLOAT3 &normal)
{
...
bool Collisions::OBBCapsuleIntersection(const OBB &obb, const Capsule &c, DirectX::XMFLOAT3 &normal, float &depth)
{
...
bool Collisions::OBBAABBIntersection(const OBB &obb, const AABB &aabb, DirectX::XMFLOAT3 &normal, float &depth)
{
...
bool Collisions::OBBTerrainIntersection(const OBB &obb, const Terrain &t, DirectX::XMFLOAT3 &normal, float &depth)
{
...
bool Collisions::AABBRayIntersection(const AABB &aabb, const Ray &ray, float &l, DirectX::XMFLOAT3 &p, DirectX::XMFLOAT3 &normal)
{
...
bool Collisions::AABBSphereIntersection(const AABB &aabb, const Sphere &s, DirectX::XMFLOAT3 &normal, float &depth)
{
	// TODO: Optimize this code
	return OBBSphereIntersection(OBB(aabb), s, normal, depth);
}

bool Collisions::AABBCapsuleIntersection(const AABB &aabb, const Capsule &c, DirectX::XMFLOAT3 &normal, float &depth)
{
	// TODO: Optimize this code
	return OBBCapsuleIntersection(OBB(aabb), c, normal, depth);
}

bool Collisions::AABBOBBIntersection(const AABB &aabb, const OBB &obb, DirectX::XMFLOAT3 &normal, float &depth)
{
	// TODO: Optimize this code
	return OBBOBBIntersection(OBB(aabb), obb, normal, depth);
}

bool Collisions::AABBTerrainIntersection(const AABB &aabb, const Terrain &t, DirectX::XMFLOAT3 &normal, float &depth)
{
...
bool RayTriangleIntersection(const Ray &r, const Triangle &t, XMFLOAT3 &normal, XMFLOAT3 &point, float &depth, XMFLOAT2 &uv)
{
...
bool RayQuadIntersection(const Ray &r, const Quad &q, XMFLOAT3 &normal, XMFLOAT3 &point, float &depth, XMFLOAT2 &uv)
{
	// TODO: Verify that this is working
	XMFLOAT3 v0, v1, v2;
	XMVECTOR u = Load(q.u),
...
void Bresenham(const XMINT2 &start, const XMINT2 &end, std::vector<XMINT2> &points)
{
...
bool BresenhamLineTraversal(const Terrain &t, int x0, int y0, int x1, int y1, std::function<bool(int, int)> callback)
{
    int dx = abs(x1 - x0);
    int dy = abs(y1 - y0);
    int sx = (x0 < x1) ? 1 : -1;
...
bool Collisions::TerrainRayIntersectionVertical(const Terrain &t, const Ray &r, DirectX::XMFLOAT3 &normal, DirectX::XMFLOAT3 &point, float &depth, bool &under)
{
...
bool Collisions::TerrainRayWallIntersectionHorizontal(const Terrain &t, const Ray &r, DirectX::XMFLOAT3 &normal, DirectX::XMFLOAT3 &point, float &depth)
{
...
bool Collisions::TerrainRayIntersection(const Terrain &t, const Ray &r, DirectX::XMFLOAT3 &normal, DirectX::XMFLOAT3 &point, float &depth)
{
	// TODO: return correct normal
    Quad q;
    Store(q.origon, XMVectorSubtract(Load(t.center), Load(t.halfLength)));
...
bool Collisions::TerrainSphereIntersection(const Terrain &t, const Sphere &s, DirectX::XMFLOAT3 &normal, float &depth)
{
	if (s.HasTag(SKIP_TERRAIN_TAG))
		return false;
...
bool Collisions::TerrainCapsuleIntersection(const Terrain &t, const Capsule &c, DirectX::XMFLOAT3 &normal, float &depth)
{
	if (c.HasTag(SKIP_TERRAIN_TAG))
		return false;
...
bool Collisions::TerrainOBBIntersection(const Terrain &t, const OBB &obb, DirectX::XMFLOAT3 &normal, float &depth)
{
	if (obb.HasTag(SKIP_TERRAIN_TAG))
		return false;
...
bool Collisions::TerrainAABBIntersection(const Terrain &t, const AABB &aabb, DirectX::XMFLOAT3 &normal, float &depth)
{
	if (aabb.HasTag(SKIP_TERRAIN_TAG))
		return false;
