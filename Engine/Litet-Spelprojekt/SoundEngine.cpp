...
bool SoundEngine::Initialize(DirectX::AUDIO_ENGINE_FLAGS flags, DirectX::AUDIO_ENGINE_REVERB reverb, float gameVolume)
{
#ifdef DEBUG_BUILD
	flags |= DirectX::AudioEngine_Debug;
#endif
	_soundEngine = std::make_unique<DirectX::AudioEngine>(flags);
...
DirectX::AudioEngine *SoundEngine::GetAudioEngine()
{
