...
struct CutsceneTimer
{
	...
	void Update(Time &time) { _currentTime += time.deltaTime; }
...
class PlayerCutsceneBehaviour : public Behaviour
{
private:
	...
	DirectX::XMFLOAT3A _movePoints[POINT_COUNT] {
	...
	DirectX::XMFLOAT4A _rotationPoints[POINT_COUNT]{
